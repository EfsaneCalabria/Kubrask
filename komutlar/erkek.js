...
await member.roles.add(erkekrol1),
...
.setDescription(`
<a:gooo:914128539303940166> **${member} Kişisi (<@&${ayarlar.erkekrol}> <@&${ayarlar.erkekrol1}>)Kayıt Edildi**
${message.author} **Toplam** \`${alldata}\` **Kayıta Sahip.**\n
**Kullanıcının Önceki Kayıtları**\n ${ismleri}`)
.setColor('RED')).then(x => x.delete({timeout: 35000}));
